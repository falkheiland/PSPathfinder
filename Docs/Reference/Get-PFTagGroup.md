...
online version: https://github.com/falkheiland/PSPathfinder/blob/main/Docs/Reference/Get-PFTagGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-PFTagGroup [-Computername] <String> [[-TCPPort] <Int32>] [[-ApiVersion] <String>]
