...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It 'Remove-PFTagGroup -Id 1 Should not throw' {
        { Remove-PFTagGroup -Id 1 } | Should -Not -Throw
      }

      It 'Remove-PFTagGroup -Id 1 -Error -ErrorAction Stop Should throw' {
        { Remove-PFTagGroup -Id 1 -Error -ErrorAction Stop } | Should -Throw
      }
    ...
    Context "Error Handling" {
      ...
      It 'should throw Error' {
        {
          Remove-PFTagGroup -Id 1 -PhoneTag 1 -Error
        } | Should throw 'Error'
      }
