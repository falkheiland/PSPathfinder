...
Describe "$Script:FunctionName Unit Tests" -Tag 'UnitTests' {
  ...
  InModuleScope $Script:ModuleName {
    ...
    Context "General Execution" {
      ...
      It 'Get-PFServiceTag Should not throw' {
        { Get-PFServiceTag } | Should -Not -Throw
      }

      It 'Get-PFServiceTag Error -ErrorAction Stop Should throw' {
        { Get-PFServiceTag Error -ErrorAction Stop } | Should -Throw
      }
    ...
    Context "Parameterset Default" {
      ...
      It 'Result should have 9 NoteProperties' {
        ($Result | Get-Member -MemberType NoteProperty).Count | Should BeExactly 9
      }
      ...
      It 'Result.Name should be exactly Service01' {
        $Result.Name | Should BeExactly 'Service01'
      }
    ...
    Context "Parameterset GetByComponentId" {
      ...
      Get-PFServiceTag -ComponentId 15
    ...
    Context "Parameterset GetByTaggroupId" {
      ...
      Get-PFServiceTag -TaggroupId 15
